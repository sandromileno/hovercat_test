RSpec.describe Hovercat::Publishers::Publisher do
  ...
  context '#publish' do
    ...
    subject! { Hovercat::Publishers::Publisher.new(connector).publish(header: header, exchange: exchange, routing_key: routing_key, payload: payload) }
    ...
    class BunnyConnectorMock
      ...
      def throw_error_on_publish
        @error = Hovercat::Exceptions::UnexpectedError.new
        self
      end
